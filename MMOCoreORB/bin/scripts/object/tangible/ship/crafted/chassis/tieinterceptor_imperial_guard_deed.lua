...
object_tangible_ship_crafted_chassis_tieinterceptor_imperial_guard_deed = object_tangible_ship_crafted_chassis_shared_tieinterceptor_imperial_guard_deed:new {
	...
	controlDeviceObjectTemplate = "object/intangible/ship/tieinterceptor_imperial_guard_pcd.iff",
	generatedObjectTemplate = "object/ship/player/player_tieinterceptor_imperial_guard.iff",
