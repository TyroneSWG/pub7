...
ObjectTemplates:addTemplate(object_tangible_ship_components_chassis_awing_chassis_token, "object/tangible/ship/components/chassis/awing_chassis_token.iff")
