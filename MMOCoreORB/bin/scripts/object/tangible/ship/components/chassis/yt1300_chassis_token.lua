...
ObjectTemplates:addTemplate(object_tangible_ship_components_chassis_yt1300_chassis_token, "object/tangible/ship/components/chassis/yt1300_chassis_token.iff")
