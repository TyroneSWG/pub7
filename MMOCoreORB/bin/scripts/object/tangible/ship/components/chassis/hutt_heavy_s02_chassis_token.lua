...
ObjectTemplates:addTemplate(object_tangible_ship_components_chassis_hutt_heavy_s02_chassis_token, "object/tangible/ship/components/chassis/hutt_heavy_s02_chassis_token.iff")
