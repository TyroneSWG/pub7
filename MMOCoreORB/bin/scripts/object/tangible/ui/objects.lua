...
object_tangible_ui_shared_ui_planet_hoth = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/ui/shared_ui_planet_hoth.iff"

}

ObjectTemplates:addClientTemplate(object_tangible_ui_shared_ui_planet_hoth, "object/tangible/ui/shared_ui_planet_hoth.iff")
