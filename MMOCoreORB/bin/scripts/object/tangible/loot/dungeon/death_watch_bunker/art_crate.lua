...
object_tangible_loot_dungeon_death_watch_bunker_art_crate = object_tangible_loot_dungeon_death_watch_bunker_shared_art_crate:new {
	objectMenuComponent = {"cpp", "RemoteWookieeHoloMenuComponent"},--TODO: This can probably turned into a Lua Class
	customName = "Kashyyyk Holo Emitter, click again to remove your Hologram"
}
