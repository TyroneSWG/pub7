...
includeFile("tangible/component/weapon/lightsaber/hig_jib_lightsaber_crystal_module.lua")
includeFile("tangible/component/weapon/lightsaber/vergence_lightsaber_crystal_module.lua")
