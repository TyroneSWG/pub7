...
--Barn deed
object_tangible_deed_player_house_deed_shared_barn = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/player_house_deed/shared_barn.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_deed_player_house_deed_shared_barn, "object/tangible/deed/player_house_deed/shared_barn.iff")
