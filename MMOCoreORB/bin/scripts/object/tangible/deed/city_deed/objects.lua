...
object_tangible_deed_city_deed_shared_shuttleport_kashyyyk_deed = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/city_deed/shared_shuttleport_kashyyyk_deed.iff"
	
}

ObjectTemplates:addClientTemplate(object_tangible_deed_city_deed_shared_shuttleport_kashyyyk_deed, "object/tangible/deed/city_deed/shared_shuttleport_kashyyyk_deed.iff")
