...
object_draft_schematic_weapon_lightsaber_mandalorian = object_draft_schematic_weapon_shared_lightsaber_mandalorian:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Jinsu Razor One Handed Lightsaber Schematic",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_mandalorian, "object/draft_schematic/weapon/lightsaber_mandalorian.iff")
