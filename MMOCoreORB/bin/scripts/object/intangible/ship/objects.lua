...
object_intangible_ship_shared_naboo_n1_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/ship/shared_naboo_n1_pcd.iff"
	
}

ObjectTemplates:addClientTemplate(object_intangible_ship_shared_naboo_n1_pcd, "object/intangible/ship/shared_naboo_n1_pcd.iff")
