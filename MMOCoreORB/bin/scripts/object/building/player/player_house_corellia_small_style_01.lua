...
object_building_player_player_house_corellia_small_style_01 = object_building_player_shared_player_house_corellia_small_style_01:new {
	...
	shopSigns = {
			{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},	
			...
			{templateFile = "object/tangible/tcg/series5/house_sign_tcg_hanging.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_01", suiItem = "Flashing Hanging Neon"},
			{templateFile = "object/tangible/tcg/series3/house_sign_tcg_s01.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_01", suiItem = "Flashing Hanging Neon series 2"},
			{templateFile = "object/tangible/sign/player/efol_hanging_sign_01.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "Ewok Festival of Love Hanging Sign"},
			{templateFile = "object/tangible/sign/player/house_address_halloween_sign.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "Hanging Halloween Sign"},
			{templateFile = "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "Imperial Empire Day Hanging Sign"},
			{templateFile = "object/tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "Alliance Remembrance Day Hanging Sign"},
			{templateFile = "object/tangible/sign/player/pgc_sign_hanging.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "Chronicle Master Hanging Sign"},
			{templateFile = "object/tangible/sign/player/wod_sm_hanging_sign_01.iff", x = -7.39, z = 3, y = 2.36, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "Witches of Dathomir Hanging Sign"},
	},	
