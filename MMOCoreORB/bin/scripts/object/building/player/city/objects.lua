...
object_building_player_city_shared_shuttleport_kashyyyk = SharedInstallationObjectTemplate:new {
	clientTemplateFileName = "object/building/player/city/shared_shuttleport_kashyyyk.iff"
	
}

ObjectTemplates:addClientTemplate(object_building_player_city_shared_shuttleport_kashyyyk, "object/building/player/city/shared_shuttleport_kashyyyk.iff")
