...
object_weapon_ranged_grenade_shared_snow_ball_weapon = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/grenade/shared_snow_ball_weapon.iff"
	}

ObjectTemplates:addClientTemplate(object_weapon_ranged_grenade_shared_snow_ball_weapon, "object/weapon/ranged/grenade/shared_snow_ball_weapon.iff")

object_weapon_ranged_grenade_shared_snow_blast_weapon = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/grenade/shared_snow_blast_weapon.iff"
	}

ObjectTemplates:addClientTemplate(object_weapon_ranged_grenade_shared_snow_blast_weapon, "object/weapon/ranged/grenade/shared_snow_blast_weapon.iff")
