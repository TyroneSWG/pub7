...
-- ours   includeFile("dungeon/warren/warren.lua")
...
includeFile("cities/yavin4_mining_outpost_imp.lua")
includeFile("cities/yavin4_mining_outpost_rep.lua")
includeFile("cities/MemorialScreenPlay.lua")
includeFile("cities/tatooine_eisley_deco_ScreenPlay.lua")

-- playerCities
----Crimson
--includeFile("playercities/crimson_night.lua")
--includeFile("playercities/crimson_night_prototype_control_center.lua")
--includeFile("playercities/crimson_night_prototype_power_station.lua")
--includeFile("playercities/crimson_night_art_dealer.lua")
--includeFile("playercities/crimson_sendpatrol.lua")
--includeFile("playercities/crimson_patrolformation.lua")
--includeFile("playercities/crimson_lambdaanimation.lua")
includeFile("playercities/citadel_republic.lua")
--includeFile("playercities/NewAldera.lua")
includeFile("playercities/core_estates_ring.lua")
includeFile("playercities/RosesScreenplay.lua")
...
--includeFile("event/shadowfortressscreenplay.lua")
--includeFile("event/Hothjeer.lua")
--includeFile("event/SFnpcs.lua")
--includeFile("event/shadowfortresscity4.lua")
--includeFile("event/shadowfortresscity3.lua")
--includeFile("event/SFmeanies.lua")
--includeFile("event/SFguards.lua")
--includeFile("event/HothJeersRebels.lua")
--includeFile("dungeon/wampa_cave.lua")
includeFile("dungeon/hoth_bio_facility.lua")
--includeFile("event/hoth_wreckage.lua")
...
includeFile("event/particle_animations.lua")
...
includeFile("event/starport_objects.lua")
includeFile("event/pvp.lua")
--includeFile("event/restuss_City.lua")
includeFile("event/durbin_matriarch.lua")
--includeFile("event/river_party.lua")
--includeFile("event/spicepatrol_Screenplay.lua")
includeFile("event/exar_yavin.lua") --EXAR KUN
...
includeFile("space/space_corellia_spawns.lua")
includeFile("space/space_dantooine.lua")
includeFile("space/space_dathomir.lua")
includeFile("space/space_endor.lua")
includeFile("space/space_lok.lua")
includeFile("space/space_naboo.lua")
includeFile("space/space_tatooine.lua")
includeFile("space/space_yavin4.lua")
includeFile("space/nova.lua")
includeFile("space/isd.lua")
includeFile("space/isd_jeodu.lua")
includeFile("space/isd_kenkirk.lua")
includeFile("space/isd_prat.lua")
includeFile("space/isd_sait.lua")
includeFile("space/isd_hangar.lua")
includeFile("space/shipwright_trainer.lua")
includeFile("space/chassis_dealer.lua")
includeFile("space/avatarScreenplay.lua")
includeFile("space/avatar_boss.lua")
includeFile("space/avatar_minione.lua")
includeFile("space/avatar_minitwo.lua")
includeFile("space/avatar_minithree.lua")
includeFile("space/avatar_prison.lua")
includeFile("event/avatar_welcome.lua")
...
-- Dromund Kaas
includeFile("military/kaas_imperial_garison.lua")
...
-- CNET Improvements
includeFile("cities/coronet_city_trainers.lua")
-- GCW Transitpilots
includeFile("gcw/gcw_transit_system.lua")
includeFile("gcw/reb_transit_system.lua")
includeFile("gcw/gcw_transit_deco.lua")
--GCW Island
--includeFile("gcw/gcw_corellia_pvp_island.lua")
includeFile("gcw/tat_bg.lua")
includeFile("gcw/spawn_tat_bg.lua")
includeFile("gcw/bgcloner_imp.lua")
includeFile("gcw/bgcloner_reb.lua")

--includeFile("gcw/isd_pvp.lua")
--includeFile("gcw/theed_lambdaanimation.lua")
--includeFile("gcw/moenia_lambdaanimation.lua")

-- GCW SupplyEvents
--includeFile("gcw/gcw_supplyevent_imp_barricade_crimson.lua")

--COIN VENDORS
includeFile("event/papa_leone_vendor.lua")
includeFile("event/obi_wan_welcome.lua")
includeFile("event/pvp_exchange.lua")
includeFile("event/restuss_exchange_dealer.lua")
includeFile("event/SmugglersPoint.lua")
includeFile("event/bloodfin_decoration_exchange.lua")
includeFile("event/exar_kun_exchange_dealer.lua")
includeFile("event/wynssa_starflare_vendor.lua")
includeFile("event/entertainer_exchange_dealer.lua")
includeFile("event/Dearic_deco_ScreenPlay.lua")
includeFile("event/thanksgiving_exchange_dealer.lua")
includeFile("event/xmas_token_exchange_dealer.lua")
includeFile("event/bloodfin_gift_store.lua")
includeFile("event/gift_store.lua")
includeFile("event/blackmarket_exchange_dealer.lua")
includeFile("event/efol_token_exchange_dealer.lua")
includeFile("event/gmf_token_exchange_dealer.lua")
includeFile("space/clone_trooper_vendor.lua")

--includeFile("event/event_xmas_randomspawn.lua")
--includeFile("event/xmas2014.lua")
--includeFile("event/loveday.lua")
--includeFile("event/halloween.lua")

--Hoth
--includeFile("dungeon/hoth_lambdaanimation.lua")
includeFile("dungeon/star_tours_transit_system.lua")
includeFile("dungeon/echo_base.lua")
includeFile("dungeon/echo_base_droid.lua")
--includeFile("dungeon/TalusPrisonBreak.lua")
includeFile("dungeon/hoth_bio_facility.lua")
--includeFile("event/hoth_wreckage.lua")
--includeFile("event/anticheatpatrol.lua")
includeFile("dungeon/corvette_pve.lua")
includeFile("event/knightTrial.lua")

--kashyyyk
includeFile("dungeon/slave_camp.lua")
includeFile("dungeon/rodian_reactor.lua")
includeFile("dungeon/bslaver_compound.lua")
includeFile("cities/kachirho_city_trainers.lua")

--restuss boss expansion
includeFile("restuss/restussTrialExpansion.lua")

--Armor Vendors (Nexxus + Mindsoft)
includeFile("gcw/Armor_Vendors/server_objects.lua")
