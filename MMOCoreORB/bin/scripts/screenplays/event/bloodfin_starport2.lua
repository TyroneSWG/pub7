...
function bloodfin_starport2:start()
	if (not isZoneEnabled("corellia")) or (not isZoneEnabled("naboo")) or (not isZoneEnabled("hoth")) then
		return 0
	end
...
function bloodfin_starport2:spawnSceneObjects()
	local pCollector = spawnSceneObject("naboo", "object/tangible/furniture/all/frn_all_command_console.iff", 4324.0, -196.7, 5160.8, 0, 0, 0, 0, 0)
...
function bloodfin_starport2:teleportHoth(pCollector, pPlayer)
	...
	playerSwitchZoneOutOfCombat(pPlayer, "hoth", -434.8, 36.6, -955.9, 0)
	return 0
end

--function bloodfin_starport2:teleportNB(pCollector, pPlayer)
--	local player = LuaSceneObject(pPlayer)
--	playerSwitchZoneOutOfCombat(pPlayer, "naboo", -4876, 6.1, 4147, 0)
--	return 0
--end

--function bloodfin_starport2:teleportCnet(pCollector, pPlayer)
--	local player = LuaSceneObject(pPlayer)
--	playerSwitchZoneOutOfCombat(pPlayer, "corellia", -159, 28, -4774, 0)
--	return 0
--end

--function bloodfin_starport2:teleportTT(pCollector, pPlayer)
--	local player = LuaSceneObject(pPlayer)
--	playerSwitchZoneOutOfCombat(pPlayer, "tatooine", -1287, 12, -3595, 85)
--	return 0
--end
...
--	local player = LuaSceneObject(pPlayer)
--	playerSwitchZoneOutOfCombat(pPlayer, "talus", 4453.6, 2.0, 5272.8, -140)
--	return 0
--end

--function bloodfin_starport2:teleportLK(pCollector, pPlayer)
--	local player = LuaSceneObject(pPlayer)
--	playerSwitchZoneOutOfCombat(pPlayer, "lok", 464.2, 8.8, 5502.6, -140)
--	return 0
--end
...
--	local player = LuaSceneObject(pPlayer)
--	playerSwitchZoneOutOfCombat(pPlayer, "dantooine", -625, 3.0, 2495.2, -127)
--	return 0
--end

--function bloodfin_starport2:teleportDR(pCollector, pPlayer)
--	local player = LuaSceneObject(pPlayer)
--	playerSwitchZoneOutOfCombat(pPlayer, "dathomir", 607.2, 6.0, 3084.8, -61)
--	return 0
--end

--[[function bloodfin_starport2:teleportYV(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	playerSwitchZoneOutOfCombat(pPlayer, "yavin4", -272.4, 35, 4882.6, -127)
--	return 0
end]]
