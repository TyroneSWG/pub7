...
--	self:createObserver(pCollector, "\\#ee3377Travel to Bloodfin Anniversary Bash", "teleportRIVER")
	...
	local pCollector2 = spawnSceneObject("naboo", "object/tangible/furniture/all/frn_all_command_console.iff", -1452.3, 15, -5668.9,  0, 0, 0, 0, 0)
...
--	self:createObserver(pCollector3, "\\#ee3377Travel to Bloodfin Anniversary Bash", "teleportRIVER")
	...
	local pCollector4 = spawnSceneObject("rivertest", "object/tangible/furniture/all/frn_all_command_console.iff", -189.0, 1.5, 536.8, 0, 0, 0, 1, 0)
	self:createObserver(pCollector4, "\\#ee3377Travel to Coronet Corellia Hub", "teleportMB")

	local pCollector10 = spawnSceneObject("naboo", "object/tangible/furniture/all/frn_all_command_console.iff", -2963.6, -191.6, 6044.3, 0, 0, 0, 1, 0)
...
function addon_starports:teleportRIVER(pCollector, pPlayer)
	playerSwitchZoneOutOfCombat(pPlayer, "rivertest", -205.2, 1.3, 537.9, 0)
	return 0
end
