...
-- Guardtowers
--spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", -2962.0, 0, -2100.0, 0, 0.707, 0, 0.707, 0)
--spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", -2990.0, 0, -2100.0, 0, 0.707, 0, 0.707, 0)
--spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", -3235.0, 0, -2100.0, 0, 0.707, 0, 0.707, 0) 
--spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", -3255.0, 0, -2100.0, 0, 0.707, 0, 0.707, 0) 
...
--FENCE ! spawnSceneObjectAutoZ("rori","object/static/structure/corellia/corl_imprv_wall_4x16_s03.iff", -3446.0, 11, -2060.0, 0, 0.707, 0, 0.707, 0) 
...
-- southwall
--myHelper.spawnHorizontalSceneObjects("rori", -3000.5, -2100.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 15, 16)
...
--myHelper.spawnVerticalSceneObjects("rori", -3272.0, -2045.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 4, 16)
--myHelper.spawnHorizontalSceneObjects("rori", -3280, -2037.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 12, 16)
-- Eastwall
--myHelper.spawnVerticalSceneObjects("rori", -3463.0, -2045.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 20, 16)
--myHelper.spawnHorizontalSceneObjects("rori", -3439.0, -2357.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 2, 16)
spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", 5210.0, 0, 6067.0, 0, 1, 0, 0, 0) 
spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", 5350.0, 0, 6068.0, 0, 0, 0, 1, 0)
spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", 5210.0, 0, 6195.0, 0, 0.707, 0, 0.707, 0) 
myHelper.spawnVerticalSceneObjects("rori", -3406.0, -2364.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 5, 16)
spawnSceneObjectlineToDirection("rori", walliff, 5275.0, 6068.0, "W", 4, 16)
spawnSceneObjectlineToDirection("rori", walliff, 5210.0, 6067.0, "N", 4, 16)
spawnSceneObjectlineToDirection("rori", walliff, 5210.0, 6131.0, "N", 4, 16)
spawnSceneObjectlineToDirection("rori", walliff, 5210.0, 6195.0, "E", 4, 16)
spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", 5277.0, 0, 6195.0, 0, 0.707, 0, 0.707, 0) 
spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", 5283.0, 0, 6195.0, 0, 0.707, 0, 0.707, 0) 
spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", 5350.0, 0, 6195.0, 0, 0.707, 0, 0.707, 0)
spawnSceneObjectlineToDirection("rori", walliff, 5286.0, 6195.0, "E", 4, 16)
spawnSceneObjectlineToDirection("rori", walliff, 5350.0, 6195.0, "S", 4, 16)
spawnSceneObjectlineToDirection("rori", walliff, 5350.0, 6131.0, "S", 4, 16)
spawnSceneObjectlineToDirection("rori", walliff, 5348.0, 6068.0, "W", 4, 16)
--westwall
...
--myHelper.spawnHorizontalSceneObjects("rori", -2931.0, -2245.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 2, 16)
--myHelper.spawnHorizontalSceneObjects("rori", -2839.0, -2376.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 8, 16)
--myHelper.spawnVerticalSceneObjects("rori", -2958.0, -2288.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 6, 16)
--spawnSceneObjectlineToDirection("rori", walliff, -2958.0, -2279.0, "SE", 11, 16)
--myHelper.spawnVerticalSceneObjects("rori", -2958.0, -2108.0, "object/static/structure/military/military_wall_med_imperial_16_style_01.iff", 9, 16)
...
--spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", -2831.0, 13.5, -2431.0, 0, -0.707, 0, 0.707, 0)
--spawnSceneObjectAutoZ("rori","object/building/military/military_outpost_guard_tower_1.iff", -2831.0, 13.5, -2407.0, 0, -0.707, 0, -0.707, 0)
-- Solarunit
...
myHelper.spawnMobileAndIdle("rori", "crimson_at_st", 600, -2930.39, 13.12, -2285.70, 90, 0 )
myHelper.spawnMobileAndIdle("rori", "crimson_at_st", 600, -3231.39, 2.4, -2075.70, 90, 0 )
-- LavaSkiff 
...
myHelper.spawnMobileAndIdle("rori", "crimson_droideka", 180, -2977, 5.5, -2072.70, 90, 0 )

myHelper.spawnMobileAndIdle("rori", "crimson_stormtrooper", 600, -3421.39, 3.1, -2370.70, 90, 0 )
myHelper.spawnMobileAndIdle("rori", "crimson_stormtrooper", 600, -3242.39, 5.4, -2678.70, 90, 0 )
myHelper.spawnMobileAndIdle("rori", "crimson_stormtrooper", 600, -2817.39, 9.25, -2430.70, 90, 0 )
...
function restuss_CityScreenPlay:spawnTurrets()
	myHelper.spawnImpTurret("rori","object/installation/faction_perk/turret/block_med.iff", -3270.0, 0.6, -2035, 0, 0, 0, 0, 0, 6)
	myHelper.spawnImpTurret("rori","object/installation/faction_perk/turret/block_med.iff", -3468.0, 0.0, -2361, 0, 0, 0, -1, 0, 6)
	myHelper.spawnImpTurret("rori","object/installation/faction_perk/turret/block_med.iff", -3228.0, 5.4, -2692.0, 0, 0, 0, -1, 0, 6)
	myHelper.spawnImpTurret("rori","object/installation/faction_perk/turret/block_med.iff", -3250.0, 5.4, -2692.0, 0, 0, 0, -1, 0, 6)
	myHelper.spawnImpTurret("rori","object/installation/faction_perk/turret/block_med.iff", -2920.0, 16.3, -2245.0, 0, 0.707, 0, 0.707, 0, 6)
end--]]
