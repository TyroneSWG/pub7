   ...
   if ( conversation ~= nil ) then
	...
	-- 5 Token Options
		...
		-- Geode from the wastelands of Hoth
	     ...
	     elseif (optionLink == "1" and itemCounter >= 5) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_belt.iff", -1)
	            DeleteItems = 5
	     ...
	     elseif (optionLink == "2" and itemCounter < 5) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "2" and itemCounter >= 5) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_belt.iff", -1)
	            DeleteItems = 5
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "3" and itemCounter < 5) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "3" and itemCounter >= 5) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_bicep_l.iff", -1)
	            DeleteItems = 5
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "4" and itemCounter < 5) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "4" and itemCounter >= 5) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_bicep_l.iff", -1)
	            DeleteItems = 5
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "5" and itemCounter < 5) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "5" and itemCounter >= 5) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_bicep_r.iff", -1)
	            DeleteItems = 5
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "6" and itemCounter < 5) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "6" and itemCounter >= 5) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_bicep_r.iff", -1)
	            DeleteItems = 5
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	...
	-- 10 Token Options
		...
		-- Tauntaun Ice Sculpture
	     elseif (optionLink == "7" and itemCounter < 10) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "7" and itemCounter >= 10) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_bracer_l.iff", -1)
	            DeleteItems = 10
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
		...
		-- Wampa Ice Sculpture
	     elseif (optionLink == "8" and itemCounter < 10) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "8" and itemCounter >= 10) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_bracer_l.iff", -1)
	            DeleteItems = 10
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "9" and itemCounter < 10) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "9" and itemCounter >= 10) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_bracer_r.iff", -1)
	            DeleteItems = 10
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "10" and itemCounter < 10) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "10" and itemCounter >= 10) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_bracer_r.iff", -1)
	            DeleteItems = 10
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "11" and itemCounter < 10) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "11" and itemCounter >= 10) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_boots.iff", -1)
	            DeleteItems = 10
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "12" and itemCounter < 10) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "12" and itemCounter >= 10) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_boots.iff", -1)
	            DeleteItems = 10
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	...
	-- 50 Token Options
		...
		-- Tauntaun Head
	     elseif (optionLink == "13" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "13" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_gloves.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "14" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "14" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_gloves.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "15" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "15" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_leggings.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "16" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "16" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_leggings.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "17" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "17" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_chest_plate.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "18" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "18" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_chest_plate.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
	     ...
	     elseif (optionLink == "19" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "19" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_helmet.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
		...
		-- Will of Exar Kun painting
	     elseif (optionLink == "20" and itemCounter < 50) then            
	            ...
	            creature:sendSystemMessage("You have insufficient items")
	     elseif (optionLink == "20" and itemCounter >= 50) then
	            local pItem = giveItem(pInventory, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_helmet.iff", -1)
	            DeleteItems = 50
		    nextConversationScreen = conversation:getScreen("end")
		    creature:sendSystemMessage("You have received a segment of armor.")
