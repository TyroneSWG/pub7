...
includeFile("conversations/events/avatar_welcome.lua")
...
includeFile("conversations/space/shipwright_trainer_exchange.lua")
includeFile("conversations/space/clone_trooper_convo.lua")
...
-- Events
includeFile("conversations/events/gmf_token_exchange.lua")
includeFile("conversations/events/thanksgiving_exchange.lua")
includeFile("conversations/events/xmas_token_exchange.lua")
includeFile("conversations/events/bloodfin_gift_store.lua")
includeFile("conversations/events/blackmarket_exchange.lua")
includeFile("conversations/events/efol_token_exchange.lua")
includeFile("conversations/events/restuss_exchange.lua")
includeFile("conversations/events/bf_decoration_exchange.lua")
includeFile("conversations/events/exar_kun_exchange.lua")
includeFile("conversations/events/wynssa_convo.lua")
includeFile("conversations/events/entertainer_exchange.lua")
includeFile("conversations/events/papa_convo.lua")
includeFile("conversations/events/obi_wan_welcome.lua")
includeFile("conversations/events/pvp_exchange_convo.lua")

--Crimson Prototype Implementation
includeFile("conversations/crimson/crimson_merchant_art.lua")
includeFile("conversations/crimson/crimson_sendpatrolconvo.lua")
includeFile("conversations/crimson/crimson_loadformation.lua")
...
-- GCW Supply Events
includeFile("conversations/gcw_quests/gcw_riflesupply.lua")

-- Hoth
includeFile("conversations/dungeon/startoursconvo.lua")
includeFile("conversations/pet/pets_conv.lua")

-- Armor Vendors (Nexxus + Mindsoft)
includeFile("conversations/Armor_Vendors/conversations.lua")
