...
chassis_dealer_greeting = ConvoScreen:new {
	id = "chassis_dealer_greeting",
        leftDialog = "",	
        customDialogText = "Greetings Starfighter. Im currently out of stock on X, Y, and A-Wings, but should have them in stock soon on a seperate vendor. Keep in mind, if you buy a deed from me, its a no trade item",
...
chassis_dealer_buy_chassis = ConvoScreen:new {
	id = "chassis_dealer_buy_chassis",
        leftDialog = "",
        customDialogText = "Dont forget, to get to space simply deploy your ship outside, and start your climb upwards, and you will auto transition to space! Happy Flying!",
