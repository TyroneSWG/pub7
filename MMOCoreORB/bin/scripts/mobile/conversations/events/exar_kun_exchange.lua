...
exar_kun_exchange_items_screen = ConvoScreen:new {
   ...
   options = {
      ...
      {"A Force Infused Bone Pile with Green Fog", "6"},
      {"A Force Infused Bone Pile with Red Fog", "7"},
      {"A Force Infused Bone Pile with Yellow Fog", "8"},
      {"A Force Infused Bone Pile with Gray Fog", "9"},      
      {"Back", "first_screen"},
...
exar_kun_exchange_first_screen = ConvoScreen:new {
   id = "first_screen",
   leftDialog = "",
   customDialogText = "Theres tales of a wandering spirit on Yavin 4, a deadly encounter, all who come upon it are usually driven mad from the experience. Find the Spirit of Exar Kun, dispatch him, and being me back the bones as they fall away from his essence, and I will reward you. Look and see what I have to offer.",
   stopConversation = "false",
   options = {
      {"Items", "items"},
      {"No thank you.", "deny_quest"},
...
exar_kun_exchange_deny_quest = ConvoScreen:new {
   id = "deny_quest",
   leftDialog = "",
   customDialogText = "You probably will never find the spirit anyway",
   stopConversation = "true",
   options = {   
   }
}
...
exar_kun_exchange_insufficient_item = ConvoScreen:new {
   ...
   leftDialog = "",
   customDialogText = "You trying to get yourself killed are you? Come back with the proof of the Spirits demise.",
   stopConversation = "true",
   options = {   
   }
}
