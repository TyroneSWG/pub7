...
createTrainerConversationTemplate("trainer_imperial_navy", "pilot_imperial_navy_master", "trainer_imperial_navy_convotemplate")
createTrainerConversationTemplate("trainer_neutral", "pilot_neutral_master", "trainer_neutral_convotemplate")
createTrainerConversationTemplate("trainer_gcw_tactics", "gcw_tactics_master", "trainer_gcw_tactics_convotemplate")
createTrainerConversationTemplate("trainer_gcw_sniper", "gcw_skill_battlefield_sniper_master", "trainer_gcw_sniper_convotemplate")
createTrainerConversationTemplate("trainer_gcw_doctor", "gcw_skill_battlefield_doctor_master", "trainer_gcw_doctor_convotemplate")
createTrainerConversationTemplate("trainer_gcw_commander", "gcw_skill_battlefield_commander_master", "trainer_gcw_commander_convotemplate")
createTrainerConversationTemplate("trainer_gcw_specialist", "gcw_skill_battlefield_specialist_master", "trainer_gcw_specialist_convotemplate")
createTrainerConversationTemplate("trainer_gcw_crafting", "gcw_skill_crafting_master", "trainer_gcw_crafting_convotemplate")
