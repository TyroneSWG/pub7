kashyyyk_varactyl_lair_neutral_boss_01 = Lair:new {
	mobiles = {{"varactyl",1},{"varactyl",1}},
...
addLairTemplate("kashyyyk_varactyl_lair_neutral_boss_01", kashyyyk_varactyl_lair_neutral_boss_01)
