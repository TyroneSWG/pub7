kashyyyk_snake_lair_neutral_boss_01 = Lair:new {
	mobiles = {{"kash_snake",1},{"kash_snake",1}},
	bossMobiles = {{"kash_mouf",1}},
	spawnLimit = 15,
...
addLairTemplate("kashyyyk_snake_lair_neutral_boss_01", kashyyyk_snake_lair_neutral_boss_01)
