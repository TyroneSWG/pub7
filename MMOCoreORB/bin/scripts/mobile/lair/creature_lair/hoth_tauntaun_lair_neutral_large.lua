hoth_tauntaun_lair_neutral_large = Lair:new {
	mobiles = {{"tauntaun_hoth",1},{"tauntaun_hoth",3}},
	spawnLimit = 15,
...
addLairTemplate("hoth_tauntaun_lair_neutral_large", hoth_tauntaun_lair_neutral_large)
