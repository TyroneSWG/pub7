kashyyyk_gurrek_lair_neutral_boss_01 = Lair:new {
	mobiles = {{"kash_gurrek",1},{"kash_gurrek",1}},
	bossMobiles = {{"varactyl",1}},
	spawnLimit = 15,
...
addLairTemplate("kashyyyk_gurrek_lair_neutral_boss_01", kashyyyk_gurrek_lair_neutral_boss_01)
