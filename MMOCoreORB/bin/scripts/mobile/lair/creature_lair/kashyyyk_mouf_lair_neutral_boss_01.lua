kashyyyk_mouf_lair_neutral_boss_01 = Lair:new {
	mobiles = {{"kash_mouf",1},{"kash_mouf",1}},
...
addLairTemplate("kashyyyk_mouf_lair_neutral_boss_01", kashyyyk_mouf_lair_neutral_boss_01)
