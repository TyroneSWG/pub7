bioengineered_stormtrooper_2 = Creature:new {
	objectName = "",
...
CreatureTemplates:addCreatureTemplate(bioengineered_stormtrooper_2, "bioengineered_stormtrooper_2")
