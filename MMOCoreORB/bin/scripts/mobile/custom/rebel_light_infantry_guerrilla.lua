rebel_light_infantry_guerrilla = Creature:new {
	objectName = "",
	customName = "5th Regiment Grunt",
	socialGroup = "rebel",
	pvpFaction = "rebel",
	faction = "rebel",
	level = 18,
...
CreatureTemplates:addCreatureTemplate(rebel_light_infantry_guerrilla, "rebel_light_infantry_guerrilla")
