...
rori = {
	...
	planetTravelPoints = {
		{name = "Restuss PvP Refugee Camp", x = 5277.7, z = 79.1, y = 6150.0, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
...
hoth = {
	...
	planetTravelPoints = {
		{name = "Imperial Correction Center", x = -2244.1, z = 120.0, y = 720.4, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
--		{name = "Abandoned Rebel Outpost", x = -644.4, z = 39.3, y = 2162.2, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
	},
...
kashyyyk = {
	...
	planetTravelPoints = {
		{name = "Kachirho", x = -4562.1, z = 100.0, y = -2273.4, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
--		{name = "Abandoned Rebel Outpost", x = -644.4, z = 39.3, y = 2162.2, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
	},
	
	planetObjects = {
		{templateFile = "object/tangible/jedi/force_shrine_stone.iff", ox = 0, oy = 0.0, oz = 0, ow = 0.0, x = 3673.2, z = 308.0, y = 7414.8, parentid = 0},
		{templateFile = "object/tangible/terminal/terminal_bank.iff", ox = 0, oy = 0.0, oz = 0, ow = 0.0, x = -4720.0, z = 82.8, y = -2301.0, parentid = 0},
--		{templateFile = "object/tangible/terminal/terminal_bazaar.iff", ox = 0, oy = 0.0, oz = 0, ow = 0.0, x = -4702.0, z = 83.0, y = -2301.0, parentid = 0},
		{templateFile = "object/tangible/terminal/terminal_mission.iff", ox = 0, oy = 0.0, oz = 0, ow = 0.0, x = -4681.0, z = 82.9, y = -2302.0, parentid = 0}
	}
}
