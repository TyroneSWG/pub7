...
veteranRewards = {
	...
	{templateFile = "object/tangible/deed/vehicle_deed/speederbike_deed.iff", milestone=20, oneTime=false, description="A new Speederbike to help you get around"},
	{templateFile = "object/tangible/veteran_reward/frn_couch_falcon_corner_s01.iff", milestone=20, oneTime=false, description="@veteran_new:falconcouch"},
	{templateFile = "object/tangible/veteran_reward/frn_couch_falcon_section_s01.iff", milestone=20, oneTime=false, description="@veteran_new:falconchair"},
	{templateFile = "object/tangible/veteran_reward/frn_vet_tie_fighter_toy.iff", milestone=20, oneTime=false, description="@veteran_new:mini_tiefighter"},
	{templateFile = "object/tangible/veteran_reward/frn_vet_x_wing_toy.iff", milestone=20, oneTime=false, description="@veteran_new:mini_xwing"},
