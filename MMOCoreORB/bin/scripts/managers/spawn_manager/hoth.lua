...
hoth_regions = {
	{"world_spawner",0,0,{1,-1},SPAWNAREA + WORLDSPAWNAREA,1,"hoth_world",2048},


}

hoth_static_spawns = {
	{"imperial_recruiter",60,-2212.2,120.0,693.2,-48,0, "neutral", "", ""},
	{"rebel_recruiter",60,-738.2,61.7,2103.9,55,0, "neutral", "", ""},
	{"at_at",60,-2107.0,59.2,821.9,12,0, "", "", ""},
