/*
 * ResarmMenuComponent.h
 *
 *  Created on: 08/19/2015
 *      Author: Heat
 */

#ifndef RESARMMENUCOMPONENT_H_
#define RESARMMENUCOMPONENT_H_
...
class ResarmMenuComponent : public TangibleObjectMenuComponent {
public:
