/*
 * RemoteWookieeHoloMenuComponent
 *
 *  Created on: 11/14/2015
 *      Author: Heat
 */

#ifndef REMOTEWOOKIEEHOLOMENUCOMPONENT_H_
#define REMOTEWOOKIEEHOLOMENUCOMPONENT_H_

#include "../TangibleObjectMenuComponent.h"

class RemoteWookieeHoloMenuComponent : public TangibleObjectMenuComponent {
public:
...
#endif /* REMOTEWOOKIEEHOLOMENUCOMPONENT_H_ */
