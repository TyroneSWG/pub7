/*
 * PlagueisMenuComponent.h
 *
 *  Created on: 06/24/2015
 *      Author: Heat
 */

#ifndef PLAGUEISMENUCOMPONENT_H_
#define PLAGUEISMENUCOMPONENT_H_

#include "TangibleObjectMenuComponent.h"

class PlagueisMenuComponent : public TangibleObjectMenuComponent {
public:
...
#endif /* PLAGUEISMENUCOMPONENT_H_ */
