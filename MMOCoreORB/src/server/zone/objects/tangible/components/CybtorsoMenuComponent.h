/*
 * CybtorsoMenuComponent.h
 *
 *  Created on: 09/01/2015
 *      Author: Heat
 */

#ifndef CYBTORSOMENUCOMPONENT_H_
#define CYBTORSOMENUCOMPONENT_H_
...
class CybtorsoMenuComponent : public TangibleObjectMenuComponent {
public:
...
#endif /* CYBTORSOMENUCOMPONENT_H_ */
