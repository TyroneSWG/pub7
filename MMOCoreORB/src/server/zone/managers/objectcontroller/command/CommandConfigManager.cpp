...
void CommandConfigManager::registerCommands() {
	...
	commandFactory.registerCommand<DancefloorCommand>(String("dancefloor").toLowerCase());
	commandFactory.registerCommand<FeaturedsoloCommand>(String("featuredsolo").toLowerCase());
	commandFactory.registerCommand<Firejets2Command>(String("firejets2").toLowerCase());
	commandFactory.registerCommand<LasershowCommand>(String("lasershow").toLowerCase());
	commandFactory.registerCommand<PositionSecuredCommand>(String("positionSecured").toLowerCase());
	commandFactory.registerCommand<BountyShieldCommand>(String("bountyShield").toLowerCase());
