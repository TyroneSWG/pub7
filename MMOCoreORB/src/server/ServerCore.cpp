...
//#include "server/zone/ZoneClientCleanupTask.h"
...
//		Task* cleanupTask = new ZoneClientCleanupTask(zoneServerRef);
//		cleanupTask->schedulePeriodic(5 * 60000, 5 * 60000);
