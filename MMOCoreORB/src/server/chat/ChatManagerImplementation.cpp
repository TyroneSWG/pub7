...
void ChatManagerImplementation::initiateRooms() {
	...
	generalRoom->setTitle("public Chat & Auction rooms for Bloodfin. You can create sub private or public chat rooms here");

	auctionRoom = createRoom("Galaxy", galaxyRoom);
